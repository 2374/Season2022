...
public class RetractFixedArmsCommand extends CommandBase{
     ...
     */
    public RetractFixedArmsCommand(ClimberSubsystem climberSubsystem) {
    ...
    @Override
    public void execute() {
        m_climberSubsystem.retractFixedArms();
    }
