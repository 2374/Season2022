 ...
 */
public class IncreaseShooterSpeedCommand extends CommandBase{
     ...
     */
    public IncreaseShooterSpeedCommand(ShooterSubsystem shooterSubsystem) {
    ...
    public void initialize() {
        m_shooterSubsystem.increasePower();
    }
