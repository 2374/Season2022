...
public final class Constants {
    ...
    // public static final double DRIVETRAIN_TRACKWIDTH_METERS = 0.55; //SWERVEE; // NAV Measure and set trackwidth
    ...
    // public static final double DRIVETRAIN_WHEELBASE_METERS = 0.47; //SWERVEE; // NAV Measure and set wheelbase
    ...
    // public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(-170.155906); // SWERVEE; // NAV Measure and set front left steer offset
    ...
    // public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(35.156179); // SWERVEE // NAV Measure and set front right steer offset
    ...
    // public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(125.859121); // SWERVEE; // NAV Measure and set back left steer offset
