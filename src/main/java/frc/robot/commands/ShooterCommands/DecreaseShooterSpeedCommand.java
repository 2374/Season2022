 ...
 */
public class DecreaseShooterSpeedCommand extends CommandBase{
     ...
     */
    public DecreaseShooterSpeedCommand(ShooterSubsystem shooterSubsystem) {
    ...
    @Override
    public void execute() {
        m_shooterSubsystem.decreasePower();
        cancel();
    }
